...
First, define a list called my_stuff .  It must be be at least 4 elements long.  The data is completely up to you, 
but it must contain at least 1 string and 1 float. 
